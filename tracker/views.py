...
def analytics_view(request):
    ...
    context = {
        'stage_labels': stage_labels, 'stage_data': stage_data,
        'avg_time_labels': avg_time_labels, 'avg_time_data': avg_time_data,
        'total_products': total_products, 'slowest_stage_name': slowest_stage,
